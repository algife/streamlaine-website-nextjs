...
const GuestbookForm = (props: IGuestbookFormProps) => {
  ...
  return (
    <form onSubmit={handleCreate}>
      <div>
        ...
        >
          ...
          <input
            ...
            className="mt-2 w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 focus:outline-none focus:ring focus:ring-sky-300/50"
            {...register('username')}
          />
        </label>
      ...
      <div className="mt-5">
        <button
          className="rounded bg-sky-500 px-5 py-1 font-bold text-white hover:bg-sky-600 focus:outline-none focus:ring focus:ring-sky-300/50"
          type="submit"
        >
          {t('save')}
        </button>
