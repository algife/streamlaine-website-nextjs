...
export default function PhoneInputFormField({
  ...
  return (
    <div className="flex flex-auto flex-col justify-stretch">
      <label
        htmlFor="phone"
      ...
      <PhoneInput
        ...
        className="block w-full rounded-l-lg px-2 py-[0.7rem] text-sm text-gray-900 placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-0 "
      />
    </div>
  );
}
